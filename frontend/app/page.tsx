...
function usd(value: number) {
  return new Intl.NumberFormat('fi-FI', { style: 'currency', currency: 'USD', maximumFractionDigits: 0 }).format(value);
}
    ...
    <main className="min-h-screen bg-eki-background px-4 py-6 text-zinc-100 md:px-8 md:py-10">
      <section className="mx-auto max-w-7xl space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          <KpiCard title="Kokonaisarvo NAV" value={usd(latest.nav)} subtitle="Salkun kokonaisarvo USD" large />
          ...
          <KpiCard title="Betting Velocity" value={usd(latest.bettingVelocity)} subtitle="Päivän panoskierto" />
        </section>
